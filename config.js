...
/*============== INFO OWNER ==============*/
global.link = {
	ig: 'https://instagram.com/mhmdepan21_',
	gh: 'https://www.tiktok.com/@mhmdepan21_?_t=8gXUuBQO2AK&_r=1',
	gc: 'https://chat.whatsapp.com/Fp18qKIoaAB71Oj1MrTzfb',
	web: 'https://youtube.com/@MhmdEpan',
	nh: 'https://nhentai.net/g/365296/'
}

/*============== PAYMENT ==============*/
global.pay = {
	dana: 'Minta owner aja gih',
	ovo: 'Minta owner aja gih',
	gopay: 'Minta owner aja gih',
	pulsa: 'Minta owner aja gih',
	qris: 'https://telegra.ph/file/8dadb05b047a86a47d0d6.jpg'
}

/*============== NOMOR ==============*/
global.info = {
	nomorbot: '62882005031113',
	nomorown: '6282226799373',
	namebot: 'piaa multi-device 10.10',
	nameown: 'Epiaaa.'
}

/*============== STAFF ==============*/
global.owner = [
    ['6282226799373', 'Epiaaa', 'true']
...
global.APIKeys = {
    ...
    'https://api.itsrose.life': 'Rk-600e6e01bec4a9a83b72c136_free_tier',
    'https://xzn.wtf' : 'vynaamd'
}

/*============== WATERMARK ==============*/
global.wm = '© piaa multi-device 10.9' //Main Watermark
global.author = '@piaadev_.'
...
global.elainajpg = [
    'https://telegra.ph/file/8dadb05b047a86a47d0d6.jpg',
...
global.stickauth = 'piaa multi-device 10.10'
